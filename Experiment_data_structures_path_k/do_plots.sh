...
python plot.py -ib "HRJN_Heap_unbounded" "HRJN_Btree_bounded" "anyk_max_Btree_bounded" "anyk_sort_Btree_bounded" \
				-iu "anyk_max_Btree_unbounded" "anyk_max_Heap_unbounded" "anyk_sort_Btree_unbounded" "anyk_sort_Heap_unbounded" -b \
				-o "plots/all" -t 'Overall comparison of ranked list implementations, Path Query, n=50, l=5' -x "Time (sec)" -y "k"

python plot.py -ib "HRJN_Heap_unbounded" "HRJN_Btree_unbounded" "HRJN_Treap_unbounded" "HRJN_Btree_bounded" "HRJN_Treap_bounded" -b \
